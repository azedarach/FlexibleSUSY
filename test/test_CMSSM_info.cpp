...
BOOST_AUTO_TEST_CASE( test_CMSSM_mass_enum )
{
   ...
   TEST_SINGLET(M2VG);
   TEST_SINGLET(MGlu);
   TEST_MULTIPLET_2(M2hh);
   TEST_MULTIPLET_2(M2Ah);
   TEST_MULTIPLET_2(M2Hpm);
   ...
   TEST_MULTIPLET_6(M2Su);
   TEST_MULTIPLET_6(M2Sd);
   TEST_MULTIPLET_6(M2Se);
   TEST_MULTIPLET_3(M2Sv);

   TEST_PHYSICAL_SINGLET(M2VP);
   TEST_PHYSICAL_SINGLET(M2VZ);
   TEST_PHYSICAL_SINGLET(M2VWm);
   TEST_PHYSICAL_SINGLET(M2VG);
   TEST_PHYSICAL_SINGLET(MGlu);
   TEST_PHYSICAL_MULTIPLET_2(M2hh);
   TEST_PHYSICAL_MULTIPLET_2(M2Ah);
   TEST_PHYSICAL_MULTIPLET_2(M2Hpm);
   ...
   TEST_PHYSICAL_MULTIPLET_6(M2Su);
   TEST_PHYSICAL_MULTIPLET_6(M2Sd);
   TEST_PHYSICAL_MULTIPLET_6(M2Se);
   TEST_PHYSICAL_MULTIPLET_3(M2Sv);
}
